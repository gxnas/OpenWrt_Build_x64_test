...
#添加bypass插件
git clone --depth=1 https://github.com/shidahuilang/openwrt-package.git package/luci-app-bypass

#添加dae插件
git clone --depth=1 https://github.com/daeuniverse/dae.git package/luci-app-daed
